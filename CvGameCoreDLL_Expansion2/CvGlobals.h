...
public:
	...
	GD_INT_MEMBER(WARMONGER_THREAT_KNOWS_ATTACKER_PERCENT); // VP
	...
	GD_INT_MEMBER(DIPLOAI_DEFENSIVE_PACT_LIMIT_BASE); // VP
	GD_INT_MEMBER(DIPLOAI_DEFENSIVE_PACT_LIMIT_SCALER); // VP
	...
	GD_INT_MEMBER(EXPERIENCE_ATTACKING_AIR_SWEEP_AIR);
	GD_INT_MEMBER(EXPERIENCE_ATTACKING_AIR_SWEEP_GROUND);
	...
	GD_INT_MEMBER(BALANCE_UNHAPPY_CITY_BASE_VALUE_DISORDER); // VP
