...
public:
	...
	GD_INT_MEMBER(UNIT_SUPPLY_CITIES_TECH_REDUCTION_DIVISOR); // VP
	...
	GD_INT_MEMBER(UNIT_SUPPLY_POPULATION_PUPPET_PERCENT); // VP
	...
	GD_INT_MEMBER(IGNORE_TERRAIN_COST_INCLUDES_RIVERS); // VP
	GD_INT_MEMBER(DIPLOAI_LIMIT_VICTORY_PURSUIT_RANDOMIZATION); // VP - Start DiploAIOptions.sql
	...
	GD_INT_MEMBER(DIPLOAI_TEMPORARY_FOR_PERMANENT_TRADING_SETTING); // VP
	...
	GD_INT_MEMBER(DIPLOAI_ENABLE_DEBUG_MODE); // VP - End DiploAIOptions.sql
	...
	GD_INT_MEMBER(BALANCE_CORE_WORLD_WONDER_SECOND_PREVIOUS_ERA_COST_MODIFIER); // VP
	...
	GD_INT_MEMBER(ESPIONAGE_SPY_RESISTANCE_MAXIMUM); // VP
	...
	GD_INT_MEMBER(ESPIONAGE_COUP_CHANCE_INCREASE_FOR_RIGGED_ELECTION_BASE); // VP
	GD_INT_MEMBER(ESPIONAGE_COUP_CHANCE_INCREASE_FOR_RIGGED_ELECTION_PER_SPY_LEVEL); // VP
	GD_INT_MEMBER(ESPIONAGE_KILL_CHANCE_DECREASE_PER_SPY_LEVEL); // VP
	GD_INT_MEMBER(ESPIONAGE_MODIFIER_SPY_LEVEL_AGENT); // VP
	GD_INT_MEMBER(ESPIONAGE_MODIFIER_SPY_LEVEL_SPECIAL_AGENT); // VP
