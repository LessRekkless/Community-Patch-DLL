...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(DIPLOAI_DEFENSIVE_PACT_LIMIT_BASE, 2),
	GD_INT_INIT(DIPLOAI_DEFENSIVE_PACT_LIMIT_SCALER, 10),
	...
	GD_INT_INIT(EXPERIENCE_ATTACKING_AIR_SWEEP_AIR, 5),
	GD_INT_INIT(EXPERIENCE_ATTACKING_AIR_SWEEP_GROUND, 2),
	...
	GD_INT_INIT(BALANCE_UNHAPPY_CITY_BASE_VALUE_POVERTY, 150),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(DIPLOAI_DEFENSIVE_PACT_LIMIT_BASE);
	GD_INT_CACHE(DIPLOAI_DEFENSIVE_PACT_LIMIT_SCALER);
	...
	GD_INT_CACHE(EXPERIENCE_ATTACKING_AIR_SWEEP_AIR);
	GD_INT_CACHE(EXPERIENCE_ATTACKING_AIR_SWEEP_GROUND);
