...
#define MOD_BALANCE_CORE_UNCAPPED_UNHAPPINESS		(MOD_COMMUNITY_PATCH && gCustomMods.isBALANCE_CORE_UNCAPPED_UNHAPPINESS())
...
#define MOD_BALANCE_CORE_RANDOMIZED_GREAT_PROPHET_SPAWNS	(MOD_COMMUNITY_PATCH && gCustomMods.isBALANCE_CORE_RANDOMIZED_GREAT_PROPHET_SPAWNS())
...
#define MOD_BALANCE_CORE_SETTLERS_CONSUME_POP		(MOD_COMMUNITY_PATCH && gCustomMods.isBALANCE_CORE_SETTLERS_CONSUME_POP())
...
#define MOD_BALANCE_CORE_XP_ON_FIRST_ATTACK			(MOD_COMMUNITY_PATCH && gCustomMods.isBALANCE_CORE_XP_ON_FIRST_ATTACK())
...
public:
	...
	MOD_OPT_DECL(BALANCE_CORE_UNCAPPED_UNHAPPINESS);
	...
	MOD_OPT_DECL(BALANCE_CORE_RANDOMIZED_GREAT_PROPHET_SPAWNS);
	...
	MOD_OPT_DECL(BALANCE_CORE_SETTLERS_CONSUME_POP);
	...
	MOD_OPT_DECL(BALANCE_CORE_XP_ON_FIRST_ATTACK);
