...
public:
	...
	pair<int, int> GetYieldPerXAdjacentImprovement(YieldTypes eYield, ImprovementTypes eImprovement) const;
...
protected:
	...
	map<YieldTypes, map<ImprovementTypes, std::pair<int, int>>> m_YieldPerXAdjacentImprovement;
