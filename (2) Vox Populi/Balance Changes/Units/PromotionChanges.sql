...
-- Remove the Helicopter UnitCombat where applicable because it is unused
DELETE FROM UnitPromotions_UnitCombatMods WHERE UnitCombatType = 'UNITCOMBAT_HELICOPTER';
...
VALUES
	...
	('PROMOTION_BUSHIDO', 'UNITCOMBAT_ARMOR'),
   	('PROMOTION_BUSHIDO', 'UNITCOMBAT_NAVALMELEE'),
