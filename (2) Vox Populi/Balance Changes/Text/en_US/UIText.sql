...
UPDATE Language_en_US
SET Text = '[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Spy is operating {1_SpyBonus} {1_SpyBonus: plural 1?Rank; other?Ranks;} higher than normal when rigging elections since this City-State is allied to a Civilization over which you have strong cultural influence. The success chance of coups is also increased.[ENDCOLOR]'
...
VALUES ('[NEWLINE][NEWLINE][COLOR_CYAN]Influence Benefits:[ENDCOLOR][NEWLINE][COLOR_POSITIVE_TEXT]Trade Routes to this Civilization Generate:[ENDCOLOR][NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+5%[ENDCOLOR] [ICON_FOOD] Growth in Origin City[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+2[ENDCOLOR] [ICON_GOLD] Gold[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+2[ENDCOLOR] [ICON_RESEARCH] Science[NEWLINE][COLOR_POSITIVE_TEXT]Espionage Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [ICON_SPY] Spies Establish Surveillance in [COLOR_POSITIVE_TEXT]5[ENDCOLOR] turns[NEWLINE][COLOR_POSITIVE_TEXT]City Conquest Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-15%[ENDCOLOR] [ICON_RESISTANCE] Unrest Time[NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-15%[ENDCOLOR] [ICON_CITIZEN] Citizen loss from City conquest' , 'TXT_KEY_CO_INFLUENCE_BONUSES_EXOTIC');

-- Update texts for tooltips based on what you changed above.
UPDATE Language_en_US
SET Text = '[NEWLINE][NEWLINE][COLOR_CYAN]Influence Benefits:[ENDCOLOR][NEWLINE][COLOR_POSITIVE_TEXT]Trade Routes to this Civilization Generate:[ENDCOLOR][NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+10%[ENDCOLOR] [ICON_FOOD] Growth in Origin City[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+4[ENDCOLOR] [ICON_GOLD] Gold[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+4[ENDCOLOR] [ICON_RESEARCH] Science[NEWLINE][COLOR_POSITIVE_TEXT]Espionage Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [ICON_SPY] Spies Establish Surveillance in [COLOR_POSITIVE_TEXT]4[ENDCOLOR] turns[NEWLINE][COLOR_POSITIVE_TEXT]City Conquest Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-30%[ENDCOLOR] [ICON_RESISTANCE] Unrest Time[NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-30%[ENDCOLOR] [ICON_CITIZEN] Citizen loss from City conquest'
WHERE Tag = 'TXT_KEY_CO_INFLUENCE_BONUSES_FAMILIAR';

-- Update texts for tooltips based on what you changed above.
UPDATE Language_en_US
SET Text = '[NEWLINE][NEWLINE][COLOR_CYAN]Influence Benefits:[ENDCOLOR][NEWLINE][COLOR_POSITIVE_TEXT]Trade Routes to this Civilization Generate:[ENDCOLOR][NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+15%[ENDCOLOR] [ICON_FOOD] Growth in Origin City[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+6[ENDCOLOR] [ICON_GOLD] Gold[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+6[ENDCOLOR] [ICON_RESEARCH] Science[NEWLINE][COLOR_POSITIVE_TEXT]Espionage Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [ICON_SPY] Spies Establish Surveillance in [COLOR_POSITIVE_TEXT]3[ENDCOLOR] turns[NEWLINE][COLOR_POSITIVE_TEXT]City Conquest Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-55%[ENDCOLOR] [ICON_RESISTANCE] Unrest Time[NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-55%[ENDCOLOR] [ICON_CITIZEN] Citizen loss from City conquest'
WHERE Tag = 'TXT_KEY_CO_INFLUENCE_BONUSES_POPULAR';

-- Update texts for tooltips based on what you changed above.
UPDATE Language_en_US
SET Text = '[NEWLINE][NEWLINE][COLOR_CYAN]Influence Benefits:[ENDCOLOR][NEWLINE][COLOR_POSITIVE_TEXT]Trade Routes to this Civilization Generate:[ENDCOLOR][NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+20%[ENDCOLOR] [ICON_FOOD] Growth in Origin City[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+8[ENDCOLOR] [ICON_GOLD] Gold[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+8[ENDCOLOR] [ICON_RESEARCH] Science[NEWLINE][COLOR_POSITIVE_TEXT]Espionage Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [ICON_SPY] Spies Establish Surveillance in [COLOR_POSITIVE_TEXT]2[ENDCOLOR] turns[NEWLINE][COLOR_POSITIVE_TEXT]City Conquest Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-80%[ENDCOLOR] [ICON_RESISTANCE] Unrest Time[NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-80%[ENDCOLOR] [ICON_CITIZEN] Citizen loss from City conquest'
WHERE Tag = 'TXT_KEY_CO_INFLUENCE_BONUSES_INFLUENTIAL';

-- Update texts for tooltips based on what you changed above.
UPDATE Language_en_US
SET Text = '[NEWLINE][NEWLINE][COLOR_CYAN]Influence Benefits:[ENDCOLOR][NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Trade Routes to this Civilization Generate:[ENDCOLOR][NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+25%[ENDCOLOR] [ICON_FOOD] Growth in Origin City[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+10[ENDCOLOR] [ICON_GOLD] Gold[NEWLINE][ICON_BULLET]  [COLOR_POSITIVE_TEXT]+10[ENDCOLOR] [ICON_RESEARCH] Science[NEWLINE][COLOR_POSITIVE_TEXT]Espionage Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [ICON_SPY] Spies Establish Surveillance in [COLOR_POSITIVE_TEXT]1[ENDCOLOR] turn[NEWLINE][COLOR_POSITIVE_TEXT]City Conquest Bonuses versus this Civilization:[ENDCOLOR][NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-100%[ENDCOLOR] [ICON_RESISTANCE] Unrest Time[NEWLINE][ICON_BULLET]   [COLOR_POSITIVE_TEXT]-100%[ENDCOLOR] [ICON_CITIZEN] Citizen loss from City conquest'
...
-- Landmark
UPDATE Language_en_US
SET Text = 'Landmarks provide +3 Empire-Wide [ICON_HAPPINESS_1] Happiness to the builder and Tile owner when constructed, as well as +1 [ICON_CULTURE] Culture and +1 [ICON_GOLD] Gold on the Tile for each additional Era that has passed in comparison to the original Era of the Artifact.[NEWLINE][NEWLINE]A Landmark is any magnificent artifact, structure, work of art, or wonder of nature that draws visitors to a location. Nelson''s Column in London is a landmark, as is Mount Rushmore in the United States. Not every significantly sized object, however, is a landmark: the World''s Largest Ball of Twine may never rise to that stature (though it might well be worth a visit).'
WHERE Tag = 'TXT_KEY_CIV5_IMPROVEMENTS_LANDMARK_TEXT';

UPDATE Language_en_US
SET Text = 'When constructed, a Landmark generates +3 Empire-Wide [ICON_HAPPINESS_1] Happiness for the builder and Tile owner. When worked, a Landmark provides [ICON_CULTURE] Culture and [ICON_GOLD] Gold based on its age. +1 [ICON_CULTURE] Culture and [ICON_GOLD] Gold per Era older than this Civilization''s current Era. Archaeologist will be consumed.'
WHERE Tag = 'TXT_KEY_CHOOSE_ARCH_LANDMARK_RESULT';

UPDATE Language_en_US
SET Text = '[NEWLINE][COLOR_POSITIVE_TEXT]Creating a Landmark in another Civilization''s territory will generate +3 Empire-Wide [ICON_HAPPINESS_1] Happiness for the builder and Tile owner, and give you a permanent diplomatic boost with that nation.[ENDCOLOR]'
WHERE Tag = 'TXT_KEY_CHOOSE_ARCH_LANDMARK_MAJOR_CIV';

UPDATE Language_en_US
SET Text = '[NEWLINE][COLOR_POSITIVE_TEXT]Creating a Landmark in a City-State''s territory will generate +3 Empire-Wide [ICON_HAPPINESS_1] Happiness for the builder and Tile owner, and will give you a large, one-time influence boost with that City-State.[ENDCOLOR]'
...
UPDATE Language_en_US
SET Text = 'The Unhappiness a City produces is no longer equal to the number of [ICON_CITIZEN] Citizens in it, although population still strongly affects Unhappiness. Unhappiness in Vox Populi is caused by several sources, each of them contributing to the total Unhappiness a City has. A detailed overview of the sources of Unhappiness in a City can be seen by hovering over the "[ICON_HAPPINESS_3] Unhappiness" tab in the City Screen. The total amount of Unhappiness in a City cannot exceed the City''s population, no matter how much Unhappiness is generated from the different sources. The only exception to this is Unhappiness from Urbanization, which always applies, even if it puts the total Unhappiness of your City above its [ICON_CITIZEN] Population. The possible sources of Unhappiness are as follows:
[NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]Unhappiness from Needs[ENDCOLOR]: Often, most of the Unhappiness in a City is caused by various Needs. With the exception of Religious Unrest, Unhappiness arises in a City if its output of a certain yield per citizen (like gold per citizen, science per citizen, etc.) is lower than the respective Needs Threshold, a reference value which is calculated based on the median output of all Cities worldwide. Unhappiness will increase as your City''s yield output per citizen decreases, typically caused by your City growing. It is therefore necessary to work to continually improve your Cities, as your population will become more and more demanding over time due to the stronger competition as other Cities improve themselves. Certain buildings and Policies reduce Unhappiness from Needs by a fixed amount, and Avoiding Population Growth can help, in the short term, to keep Unhappiness from Needs manageable.There are five main Needs, four based on different yield types and one based on religious diversity:[NEWLINE]
[COLOR_NEGATIVE_TEXT]Distress[ENDCOLOR]: Distress is based on the sum of the City''s [ICON_FOOD] Food and [ICON_PRODUCTION] Production yields. Internal Trade Routes can be used to increase a City''s [ICON_FOOD] Food or [ICON_PRODUCTION] Production output, and thus counter Distress. The Farming Process also counters Distress.[NEWLINE]
...
[COLOR_NEGATIVE_TEXT]Religious Unrest[ENDCOLOR]: Religious Unrest is produced by religious diversity rather than City yields. If a City has a Majority Religion, 1 Unhappiness is generated for every 2 [ICON_CITIZEN] Citizens not following the Majority Religion (this base value is affected by Need Modifiers). This can be reduced by using Missionaries, Inquisitors, or [ICON_PROPHET] Great Prophets to remove religious minorities.[NEWLINE]
...
[COLOR_NEGATIVE_TEXT]Pillaged Tiles[ENDCOLOR]: A City gains 1 Unhappiness for every two pillaged tiles in its vicinity. People don''t like seeing their houses burning and will start generating Unhappiness until they''re repaired.[NEWLINE]
[COLOR_NEGATIVE_TEXT]Isolation[ENDCOLOR]: An isolated City produces 1 Unhappiness for every 3 [ICON_CITIZEN] Citizens. A City is isolated if it lacks a City Connection to the [ICON_CAPITAL] Capital via a road, Lighthouse, or Trade Route. Note that Isolation can occur if a road or Lighthouse Connection is broken because of a military blockade. Trade Routes are not directly affected by blockades, but may be pillaged by the enemy units if not protected.[NEWLINE]
[COLOR_NEGATIVE_TEXT]Urbanization[ENDCOLOR]: Each Specialist in the City produces 1 Unhappiness, representing the effects of people living in large cities, such as pollution and a high population density. Unlike the other sources of Local Unhappiness, Unhappiness from Urbanization is always added to the total Unhappiness a City has, even if this puts the total Unhappiness of a City above its population. Some buildings and Policies allow a City to have "free" Specialists which generate no Urbanization.[NEWLINE]
...
[COLOR_NEGATIVE_TEXT]Public Opinion[ENDCOLOR]: After you choose an Ideology, your citizens may be influenced by the Ideologies of other Civilizations.  Civilizations of opposing Ideologies and high [ICON_TOURISM] Influence over you can foster discontent and therefore Unhappiness in your populace. If this Unhappiness is too high and your empire is unhappy, you may be forced to switch Ideologies. For more details on Ideological Pressure and Public Opinion, see the <Insert_Name_Here> in the Tourism Window after you have chosen an Ideology.'
...
UPDATE Language_en_US
SET Text = 'Public Opinion is determined by comparing the [ICON_TOURISM] Influence of Civilizations with an Ideology to your [ICON_TOURISM] Influence over them. If the another Civilization is more [ICON_TOURISM] Influential over you than you are with them, their Ideology gains some [COLOR_NEGATIVE_TEXT]Ideological Pressure[ENDCOLOR] over you. If your chosen Ideology has more Pressure combined than the others'', then your Civilization''s citizens will be [COLOR_POSITIVE_TEXT]Content[ENDCOLOR]. Otherwise, dissidents and revolutionaries will foster [ICON_HAPPINESS_4] Unhappiness in your Cities.[NEWLINE][NEWLINE]There are several ways to combat opposing Ideological Pressure:[NEWLINE][ICON_BULLET]  Improve your Influence with Civilizations with opposing Ideologies, and/or allow Civilizations with your Ideology stronger Influence over you.[NEWLINE][ICON_BULLET]  Ideologies with fewer followers have a natural resistance to opposing Ideological Pressure.[NEWLINE][ICON_BULLET]  Static or [COLOR_NEGATIVE_TEXT]Falling[ENDCOLOR] [ICON_TOURISM] Influence trends reduce a foreign Civilization''s Ideological Pressure if their culture is [COLOR_MAGENTA]Popular[ENDCOLOR] with yours.[NEWLINE][ICON_BULLET]  Adopting or switching Ideologies creates a 30-Turn (standard speed) period of reduced Ideological Pressure. You will only be able to switch to the Ideology that has the most Ideological Pressure over you, but this in itself will reduce opposing Pressure.[NEWLINE][NEWLINE]See the summary below to see what is causing Ideological Pressure. If the amount of icons for your Ideology is not greater than all the others combined, then [COLOR_NEGATIVE_TEXT]Ideological Pressure[ENDCOLOR] is generated![NEWLINE][NEWLINE]'
...
UPDATE Language_en_US
SET Text = '[NEWLINE][COLOR_POSITIVE_TEXT]Creating a Landmark in another Civilization''s territory will give you a temporary diplomatic boost with that nation.[ENDCOLOR]'
WHERE Tag = 'TXT_KEY_CHOOSE_ARCH_LANDMARK_MAJOR_CIV';
