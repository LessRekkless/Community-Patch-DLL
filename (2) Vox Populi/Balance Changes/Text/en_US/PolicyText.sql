...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Martial Spirit[ENDCOLOR]: +25% [ICON_STRENGTH] Combat Strength when attacking in melee for 50 turns, scaling with Gamespeed. [ICON_WAR] War Weariness reduced by 25%, and [ICON_RAZING] Razing Speed is doubled.'
...
-- Futurism
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Futurism[ENDCOLOR]: [ICON_TOURISM] Tourism bonus from Historic Events increased by 20%. +2 [ICON_CULTURE] Culture from [ICON_GREAT_WORK] Great Works. Earn 50 [ICON_TOURISM] Tourism when you conquer a City for the first time, scaling with Era and City size.'
...
-- Lightning Warfare
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Lightning Warfare[ENDCOLOR]: +3 [ICON_MOVES] Movement for [ICON_GREAT_GENERAL] Great Generals. Gun units gain +15% attack and ignore enemy ZOC; Armor units gain +15% attack and +1 [ICON_MOVES] Movement.'
...
-- Creative Expression
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Creative Expression[ENDCOLOR]: +2 [ICON_TOURISM] Tourism from [ICON_GREAT_WORK] Great Works. Museums, Broadcast Towers, Opera Houses, and Amphitheaters gain +3 [ICON_GOLDEN_AGE] Golden Age Points and [ICON_CULTURE] Culture.'
...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Spaceflight Pioneers[ENDCOLOR]: Gain a free [ICON_GREAT_ENGINEER] Great Engineer and [ICON_GREAT_SCIENTIST] Great Scientist. May finish Spaceship parts with [ICON_GREAT_ENGINEER] Great Engineers, and expending a [ICON_GREAT_PEOPLE] Great Person grants 100 [ICON_RESEARCH] Science, scaling with Era. Hurrying [ICON_PRODUCTION] Production with [ICON_GREAT_ENGINEER] Great Engineers now 50% more effective.'
...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Regimental System[ENDCOLOR][NEWLINE]Earn [ICON_GREAT_GENERAL] Great Generals and [ICON_GREAT_ADMIRAL] Great Admirals 33% more quickly. The [ICON_GREAT_GENERAL] Great General and [ICON_GREAT_ADMIRAL] Great Admiral [ICON_STRENGTH] Combat Bonus aura is increased by 10%, and its radius by 1 Tile.'
...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Dominance[ENDCOLOR][NEWLINE]Killing a military Unit generates [ICON_RESEARCH] Science equal to 100% of its [ICON_STRENGTH] Strength. Melee, Recon, Mounted Melee, Naval Melee, Gunpowder, and Armor Units heal for 15 points after killing a military Unit. Unit Supply generated by [ICON_CITIZEN] Population increased by 10%.'
...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Enlightenment[ENDCOLOR][NEWLINE]Receive one free Technology. +10% [ICON_RESEARCH] Science during [ICON_GOLDEN_AGE] Golden Ages. +1 [ICON_HAPPINESS_1] Happiness from Universities.'
