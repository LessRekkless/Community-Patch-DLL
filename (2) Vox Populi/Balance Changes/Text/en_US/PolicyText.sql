...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Dominance[ENDCOLOR][NEWLINE]Killing a military Unit generates [ICON_RESEARCH] Science equal to 100% of its [ICON_STRENGTH] Strength. Melee, Recon, Mounted Melee, and Naval Melee Units heal for 15 points after killing a military Unit. Unit Supply generated by [ICON_CITIZEN] Population increased by 10%.'
