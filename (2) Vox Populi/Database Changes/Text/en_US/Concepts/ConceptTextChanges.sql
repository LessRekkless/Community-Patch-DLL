...
UPDATE Language_en_US
SET Text = '[ICON_TOURISM] Tourism is the primary yield you will use to spread your cultural influence to other civilizations. It is generated passively by [COLOR_POSITIVE_TEXT]Buildings[ENDCOLOR], [COLOR_POSITIVE_TEXT]Great Works[ENDCOLOR] or [COLOR_POSITIVE_TEXT]Artifacts[ENDCOLOR][COLOR_YELLOW], and actively by [ENDCOLOR][COLOR_POSITIVE_TEXT]Historic Events[ENDCOLOR][COLOR_YELLOW] (for more on "Historic Events", see the section with this label) or completing [ENDCOLOR][COLOR_POSITIVE_TEXT]Trade Routes[ENDCOLOR][COLOR_YELLOW] (if you have constructed buildings that grant such bonuses)[ENDCOLOR]. As you place more and more Great Works and Artifacts into your Museums, Amphitheaters, Opera Houses, etc., your [ICON_TOURISM] Tourism will continue to increase.[NEWLINE][NEWLINE][COLOR_YELLOW]Your [ICON_TOURISM] Tourism is multiplied with each player in the following ways (minimum [COLOR_NEGATIVE_TEXT]-100%[COLOR_YELLOW]):[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Open Border([COLOR_POSITIVE_TEXT]+15%[COLOR_YELLOW]): Trading Open Borders to the player.[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Trade Route ([COLOR_POSITIVE_TEXT]+10%[COLOR_YELLOW]): Any Trade Route connecting your City with their City.[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Diplomat ([COLOR_POSITIVE_TEXT]+10%[COLOR_YELLOW]): Having a Diplomat in their Capital City.[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Vassal ([COLOR_POSITIVE_TEXT]+33%[COLOR_YELLOW]): Always active with a player who is your Vassal.[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Great Musician ([COLOR_POSITIVE_TEXT]+100%[COLOR_YELLOW]): After expending a Great Musician inside their borders. Also gives a [COLOR_POSITIVE_TEXT]+50%[ENDCOLOR] bonus with all other players.[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Shared Religion ([COLOR_POSITIVE_TEXT]+X%[COLOR_YELLOW]): Equal to the percentage of the player''s population following your Religion (maximum [COLOR_POSITIVE_TEXT]+50%[ENDCOLOR]).[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Different Ideologies ([COLOR_NEGATIVE_TEXT]-10%[COLOR_YELLOW]): Have a different Ideology than the player.[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Boredom ([COLOR_NEGATIVE_TEXT]-X%[COLOR_YELLOW]): Equal to the difference in Boredom between your two empires, if you have more.[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]Empire Size ([COLOR_NEGATIVE_TEXT]-X%[COLOR_YELLOW]): [COLOR_NEGATIVE_TEXT]-5%[ENDCOLOR][COLOR_YELLOW] per City you own more than the other player, excluding Puppets.[ENDCOLOR][NEWLINE][NEWLINE][COLOR_YELLOW]Additionally, certain player Abilities, Policies, Tenets, Corporations, and World Congress proposals can change this modifier. Other Abilities instead directly multiply the tourism generated in a city.[ENDCOLOR]'
